...
module.exports.WG_S3_CONFIG = process.env.WG_S3_CONFIG;
...
module.exports.WG_DEFAULT_ADDRESS = process.env.WG_DEFAULT_ADDRESS || '192.168.4.x';
...
iptables -A FORWARD -i wg0 -o ${module.exports.WG_DEVICE} -j ACCEPT;
iptables -A FORWARD -i ${module.exports.WG_DEVICE} -o wg0 -j ACCEPT;
`.split('\n').join(' ');
...
iptables -D FORWARD -i wg0 -o ${module.exports.WG_DEVICE} -j ACCEPT;
iptables -D FORWARD -i ${module.exports.WG_DEVICE} -o wg0 -j ACCEPT;
`.split('\n').join(' ');
